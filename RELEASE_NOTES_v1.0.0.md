...
```text
TheParasites_QuickStack_v1.0.0.zip
```
...
Moves matching inventory stacks into the currently opened container if that
container already contains the same item type.
